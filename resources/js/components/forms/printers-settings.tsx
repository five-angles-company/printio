    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    <Label htmlFor="receipt_printer">Instructions Printer</Label>
                    <Select
                        onValueChange={(value) => setData('instructions_printer', Number(value))}
                        value={data.instructions_printer ? String(data.instructions_printer) : ''}
                        disabled={!printers.length}
                    >
                        <SelectTrigger id="receipt_printer" className="w-full">
                            <SelectValue placeholder="Select printer" />
